                            ...
                            <div className="card1">
                                ...
                                <div class="card1">
                                    <div class="container">
                                        ...
                                        <p><b>NAME</b> : {Querys.postedBy.name}</p>
                                        <hr />
                                        <p><b>ADDRESS</b> : {Querys.postedBy.address}</p>
                                        <p><b>PHONE</b> : {Querys.postedBy.phone}</p>
                                        <p><b>QUERY</b> : {Querys.body}</p>
